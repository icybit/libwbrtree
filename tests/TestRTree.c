...
void _test_rtree_destroy() {
	...
	assert_ptr_equal(space, NULL);
	assert_ptr_equal(context, NULL);
	assert_ptr_equal(MBR_1, NULL);
	assert_ptr_equal(MBR_2, NULL);
	assert_ptr_equal(MBR_3, NULL);
	assert_ptr_equal(MBR_4, NULL);
	assert_ptr_equal(MBR_5, NULL);
	assert_ptr_equal(entry_1, NULL);
	assert_ptr_equal(entry_2, NULL);
	assert_ptr_equal(entry_3, NULL);
	assert_ptr_equal(entry_4, NULL);
	assert_ptr_equal(entry_5, NULL);
	assert_ptr_equal(rtree, NULL);
}
